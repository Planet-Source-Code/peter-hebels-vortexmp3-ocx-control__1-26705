...
Public volum As MIXERCONTROLDETAILS_UNSIGNED
...
Function GetVolumeControl(ByVal hmixer As Long, _
      ...
      Function SetVolumeControl(ByVal hmixer As Long, _
         ...
         mxcd.cbDetails = Len(volum)

         hmem = GlobalAlloc(&H40, Len(volum))
         mxcd.paDetails = GlobalLock(hmem)
         mxcd.cChannels = 1
         volum.dwValue = volume

         CopyPtrFromStruct mxcd.paDetails, volum, Len(volum)
